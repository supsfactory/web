export const en = {
  ...
  sup: {
    ...
    contact: {
      ...
      subtitle: 'Share your board type, target market, estimated quantity and launch timing. Our team will review feasibility and return with recommended specifications, MOQ guidance and next steps — typically within one business day.',      infoTitle: 'Talk to a project specialist',
      ...
      afterSubmitLines: [
        'Recommended board specifications for your target market',
        'MOQ tiers for your quantity and customization level',
        'Sample timeline and production lead time estimate',
        'An initial quote range — exact pricing after spec review',
      ],
      ndaNote: 'NDA available before you share any confidential files.',
    },
  },
  inquiry: {
