export const en = {
  ...
  admin: {
    ...
    navAdmin: 'Admin',
    overviewSub: 'Signups, activity and subscriptions across SUPsfactory.',
  ...
  sponsor: {
    ...
    title: 'Sponsor SUPsfactory', titleHl: 'SUPsfactory',
    subtitle: 'SUPsfactory is open source under Apache 2.0. Sponsorships fund maintenance, new Cloudflare modules, and support — and put your avatar on the sponsor wall. Early sponsors also get an exclusive perk when Pro launches.',
    ...
    messageLabel: 'Public message', messageOptional: 'optional', messagePlaceholder: 'SUPsfactory shipped our SaaS in a weekend',
