  ...
  es: [
    {
      ...
      metaTitle: 'Proyecto de flota SUP en resort de lujo | 100 tablas de marca — SUPsfactory',
      metaDescription:
    ...
    },
    {
      ...
      metaTitle: 'Proyecto de lanzamiento SUP de marca privada | Extensión de línea para marca existente — SUPsfactory',
      metaDescription:
      ...
      process: [
        ...
        { title: 'Escalado', body: 'Pedidos de contenedor con calidad constante; todos los diseños son de la marca.' },
      ],
      result: 'La línea agotó el lote de validación en un trimestre y escaló a pedidos de contenedor: la marca posee todos los diseños y moldes.',
      outcome: 'Validación en un trimestre, escalado a pedidos de contenedor.',
      tags: ['Extensión de marca', 'Diseño de embalaje', 'Pedidos mínimos escalables'],
    },
    {
      slug: 'club-team-boards',
      navLabel: 'Tablas de equipo para club',
      metaTitle: 'Proyecto de tablas SUP de equipo para club | Renovación de flota de club con marca — SUPsfactory',
      metaDescription:
    ...
    },
    {
      ...
      metaTitle: 'Proyecto de SUP escolar | Flota de iniciación para optativa de remo — SUPsfactory',
      metaDescription:
