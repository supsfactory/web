 ...
 * it infers the /es prefix via useLocation and renders Spanish copy for it.
 * The raw error message is shown only in dev — but note TanStack Start still
 * serializes the error's message into the dehydrated router state in the HTML,
 * so it is visible in the page source even in production. Loaders must not
 * throw errors whose messages contain secrets or internals; sanitize before
 * throwing.
 */
