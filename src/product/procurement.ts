...
export const procurementProfiles: Localized<Record<string, ProcurementProfile>> = {
  ...
  de: {
    'all-around': {
      ...
      moq: `Ab ${MOQ_SHORT.standardRun} Stück pro Projekt — Probeproduktionen ab ${MOQ_SHORT.trialStandard}`,
      leadTime: `Muster in ${FACTS.sampleTime} · Produktion in ${FACTS.leadTime} nach bestätigter Bestellung und Anzahlung`,
      specRows: [
...
export const commercialRows: Localized<ProcurementRow[]> = {
  ...
  fr: [
    ...
    { label: 'Délai d’échantillons', value: `Échantillons en ${FACTS.sampleTime} après confirmation de la spécification, de l’artwork et des conditions de paiement.` },
    { label: 'Délai de production', value: `Production en ${FACTS.leadTime} après approbation de l’échantillon, artwork final, dépôt et planification de la production.` },
  ...
  de: [
    ...
    { label: 'Musterlaufzeit', value: `Muster in ${FACTS.sampleTime} nach Bestätigung von Spezifikation, Artwork und Zahlungsanforderungen.` },
    { label: 'Produktionslaufzeit', value: `Produktion in ${FACTS.leadTime} nach Musterfreigabe, finalem Artwork, Anzahlung und Bestätigung des Produktionsplans.` },
