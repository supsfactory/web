...
export const enProduct = {
  ...
  sup: {
    nav: {
      ...
      productsServicesDropdown: {
        ...
        odmManufacturing: 'ODM Manufacturing',
        productDevelopment: 'SUP Product Development',
        newBrandTrial: 'New-Brand Trial Order (Low MOQ)',
        oemPaddle: 'OEM Paddle (Private Label)',
      },
      ...
      proofQualityDropdown: {
        ...
        verifyFactory: 'Factory Verification',
    ...
    footer: {
      ...
      owner: `${SITE_NAME} — SUP manufacturing division of ${BRAND_COMPANY_NAME}.`,
    ...
    contact: {
      ...
      subtitle:
        'Send your product specification, reference board, drawings or product concept. Our team will review the requirements and recommend the most practical path to prototype and production. NDA available before file exchange.',
  ...
  inquiry: {
    ...
    name: 'Name',
    nameHint: 'Your name, so we know who to address your project review to.',
    ...
    submit: 'Request Manufacturing Review',
    submitting: 'Submitting…',
    projectType: 'Project Type',
    projectTypeHint: 'How you want to build works with our factory. Most projects land between these modes and we quote the configuration that matches how much of the design you want to own.',
    projectTypeOptions: {
      oem: 'OEM — produce my existing design',
      odm: 'ODM — develop a product from my brief',
      'private-label': 'Private label — my brand on a validated platform',
      prototype: 'Prototype / sample development',
      bulk: 'Bulk production of an existing lineup',
      other: 'Other',
    },
    existingDesign: 'Do You Have an Existing Design?',
    existingDesignHint: 'Enough to route your project: CAD and drawings go to engineering review; reference products go to a manufacturability report; concept-only projects start in ODM.',
    existingDesignOptions: {
      cad: 'CAD files',
      drawing: 'Technical drawings or specs',
      reference: 'Reference product to match',
      'existing-sup': 'An existing SUP we can adapt',
      concept: 'Concept or idea only',
    },
    okA: {
