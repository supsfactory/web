...
export const esProduct = {
  ...
  sup: {
    nav: {
      ...
      productsServicesDropdown: {
        ...
        odmManufacturing: 'Fabricación ODM',
        productDevelopment: 'Desarrollo de Producto SUP',
        newBrandTrial: 'Pedido de Prueba para Marcas Nuevas',
        oemPaddle: 'Pala OEM (marca propia)',
      },
      ...
      proofQualityDropdown: {
        ...
        manufacturingCapabilities: 'Capacidades de fabricación',
        verifyFactory: 'Verificación de fábrica',
    ...
    contact: {
      ...
      subtitle:
        'Envía tu especificación de producto, tabla de referencia, planos o concepto de producto. Nuestro equipo revisará los requisitos y recomendará la vía más práctica hacia el prototipo y la producción. NDA disponible antes del intercambio de archivos.',
  ...
  inquiry: {
    ...
    name: 'Nombre',
    nameHint: 'Tu nombre, para saber a quién dirigir la revisión de tu proyecto.',
    ...
    submit: 'Solicitar Revisión de Fabricación',
    submitting: 'Enviando…',
    projectType: 'Tipo de Proyecto',
    projectTypeHint: 'Cómo quieres que tu producto se desarrolle con nuestra fábrica. La mayoría de los proyectos se sitúan entre estos modos y cotizamos la configuración que coincide con cuánto diseño quieres poseer.',
    projectTypeOptions: {
      oem: 'OEM — producir mi diseño existente',
      odm: 'ODM — desarrollar un producto a partir de mi brief',
      'private-label': 'Marca privada — mi marca en una plataforma validada',
      prototype: 'Desarrollo de prototipo / muestra',
      bulk: 'Producción en volumen de una línea existente',
      other: 'Otro',
    },
    existingDesign: '¿Tienes un Diseño Existente?',
    existingDesignHint: 'Suficiente para orientar tu proyecto: los CAD y los planos pasan a revisión de ingeniería; los productos de referencia pasan a un informe de fabricabilidad; los proyectos solo-concepto comienzan en ODM.',
    existingDesignOptions: {
      cad: 'Archivos CAD',
      drawing: 'Planos técnicos o especificaciones',
      reference: 'Producto de referencia a igualar',
      'existing-sup': 'Un SUP existente que podemos adaptar',
      concept: 'Solo concepto o idea',
    },
    okA: {
