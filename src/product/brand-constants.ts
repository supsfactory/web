...
export const PRODUCT_BOILERPLATE =
  'iSupfactory is the SUP product development and manufacturing division of Qingdao Vatrad Group Co., Ltd., a 12,500 m\u00b2 inflatable manufacturing plant in Qingdao, China.'
...
export const PRODUCT_OG_IMAGE_FILENAME = 'isupfactory-og-default'
