...
/**
 * Entity hub (/about/isupfactory-entity) — the GEO-facing page that links
 ...
 * describe "what iSupfactory is".
 */
export const Route = createFileRoute('/{-$locale}/about/isupfactory-entity')({
  loader: async ({ params }) => {
