...
import { llmProductsIndex, llmLandingsIndex, llmAfarerIndex } from '@/features/site/llm'
...
const handler = () =>
  new Response(llms(source).index() + llmProductsIndex() + llmLandingsIndex() + llmAfarerIndex(), {
