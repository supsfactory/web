...
import { llmProductsIndex, llmSolutionsIndex, llmAfarerIndex } from '@/features/site/llm'
...
const handler = () =>
  new Response(llms(source).index() + llmProductsIndex() + llmSolutionsIndex() + llmAfarerIndex(), {
