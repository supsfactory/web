  ...
  head: () => ({
    meta: [
      ...
      { title: 'SUPsfactory �?Launch Your Own SUP Brand' },
      {
        name: 'description',
        content:
          'Create your own SUP brand without building your own factory. Custom SUP manufacturing for startups, clubs, resorts and businesses �?low MOQ �?pilot runs from 20�?0pcs �?plus full customization and design support.',
      },
      { property: 'og:title', content: 'SUPsfactory �?Launch Your Own SUP Brand' },
      {
        property: 'og:description',
        content:
          'Custom SUP manufacturing with low MOQ (pilot runs from 20�?0pcs), full customization and professional design support. For startups, clubs, resorts and businesses.',
      },
      { property: 'og:type', content: 'website' },
    ],
    links: [
      { rel: 'stylesheet', href: appCss },
      // Hero LCP + 页内图片大多来自 assets.supsfactory.com（跨�?R2 CDN），
      // 提前建连能省掉一�?TCP+TLS 往返，直接缩短 LCP�?      { rel: 'preconnect', href: 'https://assets.supsfactory.com' },
      ...
      // CTA 按钮(font-bold=Inter 700)�?chips/次按�?font-semibold=Inter 600)
      // 是首屏文本：预载避免它们�?CSS 解析后才被发�?弱网多一�?RTT/FOUIT 闪变)�?      { rel: 'icon', href: '/favicon.ico', sizes: '48x48' },
...
function RootComponent() {
  ...
  // /docs �?locale 组外且内容目前只有中文——lang 跟内容走，别向搜索引�?读屏标错语言
  // （docs 翻译成英文时同步改这里；生产 /docs → edge-gate 410，此分支仅 dev 生效）
